...
import logoImage from "assets/images/cloudVedhLogo.jpeg"
/**
...
const Logo = () => {
  ...
  return (
     ...
     */
    <>
      <img src={logoImage} alt="Mantis" width="110" />
...
//       muted 
//       playsInline
//       className="w-[118px] h-[35px] object-contain"
//     >
//       {/* Replace the src with your actual video file path */}
//       <source src={logoImage} type="image/png" />
